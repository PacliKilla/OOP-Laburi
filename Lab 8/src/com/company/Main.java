...
public class Main
{
    public static void main(String[] args) {
        ...
        System.out.println("Biggest Surface : " + biggestSurface + " Surface: " + biggestSurface.getSurface());
        System.out.println("Biggest Volume : " + biggestVolume + " Volume: " + biggestVolume.getVolume());
